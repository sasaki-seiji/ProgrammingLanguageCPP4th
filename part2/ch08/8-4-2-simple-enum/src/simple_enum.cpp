...
//Warning a1 = 7;
	// invalid conversion from 'int' to 'Warning' [-fpermissive]
int a2 = green;
...
void f(Traffic_light x)
{
	...
	if (x == red) { cout << "hit: x == red\n"; }
		// comparison between 'enum Traffic_light' and 'enum Warning' [-Wenum-compare]
...
Flag f0{ };
//Flag f1 = 5;
	// invalid conversion from 'int' to 'Flag' [-fpermissive]
//Flag f2 = Flag{5};
	// invalid conversion from 'int' to 'Flag' [-fpermissive]
