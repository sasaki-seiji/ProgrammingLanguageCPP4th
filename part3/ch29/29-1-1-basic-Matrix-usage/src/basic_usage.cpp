...
void initialize_from_matrix_initializer()
{
	...
	cout << "Matrix<double,0> md0{1}: " << md0 << endl;
	cout << "Matrix<double,1> md1{1,2,3,4}: " << md1 << endl;
...
void initialize_from_sizes()
{
	...
	cout << "Matrix<double,3> md3(4,7,9);\n";
	cout << "  md3.desc: " << md3.descriptor() << endl;
	cout << "  md3: " << md3 << endl;
	cout << "Matrix<double,17> md17;\n";
...
void various_element_type()
{
	...
	cout << "Matrix<double,2> md; typeid(md): " << typeid(md).name() << endl;
	cout << "Matrix<string,2> ms; typeid(ms): " << typeid(ms).name() << endl;
}
...
void index_access()
{
	...
	cout << "Matrix<double,2> m {...}; m: " << m << endl;
