...
{
	cout << "--- test_Matrix_ref_addassign_Matrix() --\n";
...
void test_Matrix_ref_addassign_Matrix_ref()
{
	cout << "--- test_Matrix_ref_addassign_Matrix_ref() --\n";
...
void test_Matrix_ref_add_Matrix()
{
	cout << "--- test_Matrix_ref_add_Matrix() --\n";
...
{
	cout << "--- test_Matrix_ref_subassign_Matrix() --\n";
...
{
	cout << "--- test_Matrix_ref_subassign_Matrix_ref() --\n";
...
{
	cout << "--- test_Matrix_ref_sub_Matrix() --\n";
...
void test_Matrix_ref_sub_Matrix_ref()
{
	cout << "--- test_Matrix_ref_sub_Matrix_ref() --\n";
